...
import com.example.newseditorial.Utill.NestedWebView;
import com.example.newseditorial.Utill.PicassoImageGetter;
                        ...
                        .withEndAction(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if(isDark){
                                    ...
                                    theAwesomeView.setBackgroundColor(ContextCompat.getColor(news_details.this,R.color.white));
                                }
                                            ...
                                            .setConfirmClickListener(new KAlertDialog.KAlertClickListener() {
                                                ...
                                                public void onClick(KAlertDialog  sDialog) {
                                                    ...
                                                    if (b == 1) {
                                                        ...
                                                        Toasty.success(getApplicationContext(), "Done.", Toast.LENGTH_SHORT).show();
                                                        Intent myIntent = new Intent(news_details.this, MainActivity.class);
                                                        myIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                        startActivityForResult(myIntent, 0);
                                                    } else {
...
//                        .withTranslateDuration(...)
        ...
        final View theWonderfulButton4 = findViewById(R.id.the_wonderful_button4);
        theWonderfulButton4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Revealator.unreveal(theAwesomeView)
                        .to(fab)
...
//                        .withTranslateDuration(...)
                        .withEndAction(new Runnable() {
                            ...
                            public void run() {
                                ...
                                String charSequence = news_details.getText().toString();
                                Toasty.info(getApplicationContext(),charSequence,Toast.LENGTH_LONG).show();
                                Pattern re = Pattern.compile("[^.!?\\s][^.!?]*(?:[.!?](?!['\"]?\\s|$)[^.!?]*)*[.!?]?['\"]?(?=\\s|$)", Pattern.MULTILINE | Pattern.COMMENTS);
                                Matcher reMatcher = re.matcher(charSequence);

                                Pattern re1 = Pattern.compile("[^।!?\\s][^।!?]*(?:[।!?](?!['\"]?\\s|$)[^।!?]*)*[।!?]?['\"]?(?=\\s|$)", Pattern.MULTILINE | Pattern.COMMENTS);
                                    ...
                                    public void onError() {
                                        ...
                                        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View view) {
                                                ...
                                                icon.setTint(Color.WHITE);
                                                //     button.setBackground(icon);
                                                Intent myIntent = new Intent(news_details.getContext(), MainActivity.class);
                                                myIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                startActivityForResult(myIntent, 0);
                                            }
                                        });
