...
public class add_news extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout subbb = findViewById(R.id.newslay);
        ...
        if (isDark) {
            ...
            subbb.setBackground(ContextCompat.getDrawable(this,R.drawable.background_card_dark));
            ...
            subbb.setBackground(ContextCompat.getDrawable(this,R.drawable.background_card));
